class TaxCalculator(object):
    ...
    HEALTH_INSURANCE_RATE_SECONDARY = 7.75 / 100
    TAX_RATE = 18 / 100
    REDUCED_TAX = 46.33
    ...
    health_insurance_tax = 0 # 9% of the income
    health_insurance_reduce_tax = 0 # 7,75% of the income
    t_advance = 0 # advance tax = 18%
     # tax free income 46,33 PLN
    advanceTax = 0
    advanceTax0 = 0
    ...
    def main():
        ...
        if TaxCalculator.contractType=="E":
            ...
            print("Healt social security tax: 9% = " \
                  +"{0:.2f}".format(TaxCalculator.health_insurance_tax_rate_primary)+" 7,75% = "+"{0:.2f}".format(TaxCalculator.health_insurance_tax_secondary))
